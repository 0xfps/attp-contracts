...
export interface PoseidonT2Interface extends Interface {
...
export interface PoseidonT2 extends BaseContract {
  connect(runner?: ContractRunner | null): PoseidonT2;
  ...
  hash: TypedContractMethod<[arg0: [BigNumberish]], [bigint], "view">;
